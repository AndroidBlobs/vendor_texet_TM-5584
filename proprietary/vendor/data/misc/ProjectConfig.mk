...
AUTO_ADD_GLOBAL_DEFINE_BY_VALUE = CUSTOM_HAL_LENS BOOT_LOGO MTK_AUDIO_BLOUD_CUSTOMPARAMETER_REV MTK_PLATFORM CUSTOM_KERNEL_LENS CUSTOM_KERNEL_MAIN_BACKUP_LENS MTK_MODEM_SUPPORT MTK_BT_CHIP MTK_WLAN_CHIP CUSTOM_KERNEL_FLASHLIGHT CUSTOM_KERNEL_SUB_LENS MTK_FM_RX_AUDIO MTK_COMBO_CHIP MTK_GPS_CHIP CUSTOM_KERNEL_SUB_BACKUP_LENS CUSTOM_KERNEL_MAIN_LENS MTK_FM_TX_AUDIO MTK_FM_CHIP BOOT_LOGO
BOOT_LOGO = fwvgaplus
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
...
CUSTOM_KERNEL_ALSPS = tp_proximity
...
CUSTOM_MODEM = g1859phv1_c_ulwtg_cogps
...
DIGI_FOTA_SUPPORT = yes
MTK_AAL_SUPPORT=yes
############################### TEKSUN BEGIN#####################################
TEKSUN_DRIVE_COMMON_BOARD_DWS_NAME = H939HA_V4
XUNHU_PROJECT_MEMORY_TYPE=39.648
XUNHU_RF_MODE=FDD3M
XUNHU_LPS_TEKHW_SUPPORT=yes
MTK_BUILD_VERNO=TM5584-R01-30.05.2019-V1.0
BUILD_GMS=yes
CUSTOM_KERNEL_FINGERPRINT=microarry_e064n
XUNHU_LPS_AUXILIARYCAMERA_SUPPORT=yes
XUNHU_BOKEH_SUPPORT=yes
XUNHU_COMMON_FLASHLIGHT_SUB_LED=no
############################### TEKSUN END#####################################
#统一设置型号、MTP、PTP、WIFI AP、USB、BT和磁盘名称
XUNHU_MODEL=TM-5584
# 设置品牌名称，可以带空格
XUNHU_BRAND=Texet
#设置设备名称，设备名称最好不带空格，否则导致添加第三方应用出错.如goole play
XUNHU_DEVICE=TM-5584
#设置手机名称,手机名称最好不带空格，否则导致添加第三方应用出错.如goole play
XUNHU_NAME=TM-5584
#设置手机制造商名称
XUNHU_MANUFACTURER=Sanmu
# 蓝牙名称，no为不设置，其他值为要设置的名称，可以带空格
XUNHU_BT=TM-5584

XUNHU_CUSTOM_CLIENT_ID=android-sanmu
#使用方法:yes/no,默认no
XUNHU_COMMON_CTS_CONFIG=yes
###Description: CTS 出口俄罗斯软件配置
XUNHU_COMMON_CTS_RUSSIA_CONFIG=yes

#作者:TRF318
#功能:TEE
#使用方法:yes/no,默认no, 下面四个宏需要同时打开，
#同时需要打开kernel-autoconfig　CONFIG_TRUSTKERNEL_TEE_SUPPORT=y
#对于1G一下的，MTK_TEE_DRAM_SIZE这个值带指纹为0x1400000，不带指纹这个值为0x600000
...
XUNHU_DEFAULT_TIMEZONE=Europe/Moscow

# 使用方法：CUST自定义关机动画，NONE关机使用进度条
XUNHU_SHUTDOWN_ANIMATION=NONE
...
# 功能：默认24小时时间制
# 使用方法：yes打开no关闭
XUNHU_SYSTEM_TIME_DEFAULT_24=yes

XUNHU_ADJUST_CODE_FOR_DEFAULT_VALUE_SET=yes
XUNHU_STREAM_VOICE_CALL=6
XUNHU_STREAM_SYSTEM=15
XUNHU_STREAM_RING=15
XUNHU_STREAM_MUSIC=15
XUNHU_STREAM_ALARM=15
XUNHU_STREAM_NOTIFICATION=15

XUNHU_ADD_RAM_ROM_SHOW=no
XUNHU_LAUNCHER_TITLE_DISPLAY_TWO_LINES=yes
#功能:俄罗期项目拔号盘添加俄文字符
#使用方法:yes/no,默认no
...
#手写IMEI功能
XUNHU_IMEI_SETTINGS = yes
ADUPS_FOTA_SUPPORT = no
MTK_OMADM_SUPPORT = no
XUNHU_REMOVE_HIGH_TEMPERATURE_WARNING=yes

#TEKSUN_HARDWARE_CAMERA_SUPPORT = gc5025_mipi_raw gc2385_mipi_raw_sub gc5025_mipi_raw_sub gc2385_mipi_raw
TEKSUN_HARDWARE_CAMERA_SUPPORT = gc2385_mipi_raw_sub gc5025_mipi_raw_sub sp5508_mipi_raw gc5025_mipi_raw gc2385_mipi_raw sp250a_mipi_raw
TEKSUN_MT6739_I2C_EXTERNAL_PULLUP_RESISTANCE=no
